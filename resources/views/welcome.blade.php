        ...
        <div class="container">
            <div class="slider-active">
                <div class="slider-single-item">
                    <img src="{{ asset('uploads/img/slider-img2.jpg') }}" class="img-fluid" alt="no image">
                ...
                <div class="slider-single-item">
                    <img src="{{ asset('uploads/img/slider-img2.jpg') }}" class="img-fluid" alt="">
                    <div class="slider-text">
                        <h2>Cherner <span>Armchair</span></h2>
                        <p>The 1958 moulded plywood armchair by Norman Cherner.</p>
                        <a href="#">View now</a>
                ...
                <div class="slider-single-item">
                    <img src="{{ asset('uploads/img/slider-img3.jpg') }}" class="img-fluid" alt="">
                    <div class="slider-text">
                        <h2>Cherner <span>Armchair</span></h2>
                        <p>The 1958 moulded plywood armchair by Norman Cherner.</p>
                        <a href="#">View now</a>
                    ...
                    <div class="col-md-3">
                        <div class="product-wrapper">
                            <div class="product-img">
                                <a href="{{ route('product.details', $latestproduct->id) }}"> <img
                                        src="{{ asset('uploads/productImage') }}/{{ $latestproduct->product_image }}"
                                        alt=""></a>
                            ...
                            <div class="product-content text-center">
                                <h3><a
                                        href="{{ route('product.details', $latestproduct->id) }}">{{ $latestproduct->name }}</a>
                                </h3>
                                <div class="rating">
                                ...
                                <div class="cart-btn">
                                    <form action="{{ route('cart.add') }}" method="POST" class="cart-and-action">
                                        ...
                                        <div class="quanty clearfix mb-5">
                                            <input type="hidden" name="pro_id" value="{{ $latestproduct->id }}">

                                            <div class="float-left">
                                                <input type="hidden" name="product_quantity" id="" value="1" min="1">
                                            </div>
                                        </div>
                                        <div class="cart-pro ">
    ...
    <div class="banner-area pb-5">
        <div class="container">
            <div class="banner-img">
                <a href="#"><img class="img-fluid" src="{{ asset('uploads/img/banner-img/banner.jpg') }}"
                        alt=""></a>
            </div>
        </div>
    </div>
                ...
                <div class="col-xl-12">
                    <div class="product-tab">
                        <ul class="nav" role="tablist">
                            ...
                            <li class="nav-item pb-5">
                                <a class="nav-link" data-toggle="tab" id="l2" href="#lighting1"
                                    role="tab">Lighting</a>
                            </li>
                            <li class="nav-item pb-5">
        ...
        <div class="container ">
            <div class="row">
                <div class="brand-active owl-carousel ">
                    <div class="single-brand"><a href=""><img src="{{ asset('uploads/img/brand/brand1.jpg') }}"
                                alt="" class=""></a></div>
                <div class=" single-brand"><a href=""><img
                                    src="{{ asset('uploads/img/brand/brand1.jpg') }}" alt=""
                                    class=""></a></div>
                <div class=" single-brand"><a href=""><img
                                        src="{{ asset('uploads/img/brand/brand1.jpg') }}" alt=""
                                        class=""></a></div>
                <div class=" single-brand"><a href=""><img
                                            ...
                                            class=""></a></div>
                <div class=" single-brand"><a href=""><img
                                                src="{{ asset('uploads/img/brand/brand1.jpg') }}" alt="" class=""></a>
                    </div>
                </div>
            </div>
        </div>
